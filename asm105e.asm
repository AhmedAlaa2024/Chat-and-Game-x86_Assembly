...
START_GAME PROC NERA
    ...
    ; Send Signal (Game Request Flag) And Wait For Result From Other Player
    MOV SEND_VALUE,AH
    CALL SEND_CHAR
    @@CHECK_SERIAL:
    MOV DX, 3FDH
    ...
    JZ @@CHECK_SERIAL
    CALL RECIEVE_CHAR
    ; Send Name and Initial Points 
    ; Display Choose Game Level 
    ; Send Game Level And Show The Choose Forbidden Char Screen 
...
ACCEPT_GAME PROC NEAR 
    ...
    ; Show Select Game Level 
    ; Show The Choose Forbidden Char Screen 
    ; Continue Game As Phase 1
ACCEPT_GAME ENDP

MAIN_SCRREN_BUFFER PROC NERA
    CMP AH, 59 ; F1 SCAN Code
    JE @@Chatting
