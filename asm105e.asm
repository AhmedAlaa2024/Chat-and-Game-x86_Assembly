...
RESET_VALUES PROC NEAR
    ...
    MOV WORD PTR PLAYER_1_MEM_0_VALUE, AX
    MOV WORD PTR PLAYER_1_MEM_2_VALUE, AX
    MOV WORD PTR PLAYER_1_MEM_4_VALUE, AX
    MOV WORD PTR PLAYER_1_MEM_6_VALUE, AX
    MOV WORD PTR PLAYER_1_MEM_8_VALUE, AX
    MOV WORD PTR PLAYER_1_MEM_A_VALUE, AX
    MOV WORD PTR PLAYER_1_MEM_C_VALUE, AX
    MOV WORD PTR PLAYER_1_MEM_E_VALUE, AX
    ...
    MOV WORD PTR PLAYER_2_MEM_0_VALUE, AX
    MOV WORD PTR PLAYER_2_MEM_2_VALUE, AX
    MOV WORD PTR PLAYER_2_MEM_4_VALUE, AX
    MOV WORD PTR PLAYER_2_MEM_6_VALUE, AX
    MOV WORD PTR PLAYER_2_MEM_8_VALUE, AX
    MOV WORD PTR PLAYER_2_MEM_A_VALUE, AX
    MOV WORD PTR PLAYER_2_MEM_C_VALUE, AX
    MOV WORD PTR PLAYER_2_MEM_E_VALUE, AX
