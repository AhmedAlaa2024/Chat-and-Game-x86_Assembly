...
;           GAME STATE
;==================================
P1_FORBIDDEN_CHARATER DB 'Z'
P2_FORBIDDEN_CHARATER DB 'Z'
...
EXECUTE_THIRD_POWER_UP PROC NEAR
    ...
    TEST CURR_PLAYER_FLAG, 1 ;ZF = 1 if Player 1
    JNZ @@PLAYER2_E
    MOV P2_FORBIDDEN_CHARATER, AL
    JMP @@REST
    @@PLAYER2_E:
    MOV P1_FORBIDDEN_CHARATER, AL
...
MAIN PROC FAR
    ...
    UPDATE_TIMER:
    MOV DH,0
    MOV Dl,P1_FORBIDDEN_CHARATER
    MOV PLAYER_1_SP_VALUE,DX
    
    MOV DH,0
    MOV Dl,P2_FORBIDDEN_CHARATER
    MOV PLAYER_2_SP_VALUE,DX
    ;Check buffer
    MOV AH, 1
    INT 16h
    JZ SKIP_HANDLE 
